...
از تاریخ ۱۳ دی ماه ۱۴۰۱ (برابر با ۳ ژانویه ۲۰۲۳)، لیست **PersianBlocker** از سایت های تاجیکستانی به زبان پارسی (با الفبای سیرلیکی) پشتیبانی می‌کند.

> Аз таърихи 13 даии моҳи 1401 (баробар бо 3 январи 2023), листи **PersianBlocker** аз сайтҳои тоҷикистонӣ ба забони порсӣ (бо алифбои тоҷикӣ) пуштибонӣ мекунад.

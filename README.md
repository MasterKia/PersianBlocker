...
⚠️ مرورگر برومیت برای اندروید، مسدودساز داخلی داره اما از فیلتر های CSS (برای پنهان کردن تبلیغات و موارد دیگه) و از فیلتر های جاوااسکریپتی پشتیبانی نمیکنه. با این حال شما میتونید به کمک [این آموزش](https://github.com/xarantolus/filtrite#using-your-own-filter-lists)، یک لیست برپایه PersianBlocker و سازگار با برومیت بسازید.
